...
describe('test Input component', () => {
    it('should render the correct default Input', () => {
        ...
        expect(testNode).toHaveClass('laura-input-inner');
    ...
    it('should render different input size on size property', () => {
        ...
        const testContainer = wrapper.container.querySelector('.laura-input-wrapper');
    ...
    it('should render prepand and append element on prepend/append property', () => {
        ...
        const testContainer = container.querySelector('.laura-input-wrapper')
